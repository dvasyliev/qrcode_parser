...
const transform2 = (definitions, fields) => {
  ...
  definitions.forEach(definition => {
    ...
    if (_.has(definition, 'children') && _.isArray(field.value)) {
      modelChild = transform2(definition.children, field.children)
    }

    model[definition.name] = _.has(field, 'value') ? field.value : modelChild
  })
